...
const GalleryAbout = () => {
  return (
    <section className="mx-0 lg:mx-16  grid grid-cols-1 md:grid-cols-12 lg:xl:2xl:grid-cols-12 xl:container xl:mx-auto  w-full h-full ">
        ...
        {/* <nav className="hidden font-heading text-xs md:flex uppercase" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              <li className="inline-flex items-center  cursor-pointer">
                <a
                  href="#"
                  className="inline-flex items-center  font-semibold text-gray-400 hover:text-[#d77b5d] dark:text-gray-400 dark:hover:text-white"
                >
                  <svg
              ...
              <li className="cursor-pointer">
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className="ms-1  font-semibold text-gray-400 hover:text-[#d77b5d] md:ms-2 dark:text-gray-400 dark:hover:text-white"
                  >
                    Page
                  </a>
                </div>
              ...
              <li aria-current="page" className="cursor-pointer">
                <div className="flex items-center">
                  ...
                  <span className="ms-1   font-semibold text-[#d77b5d]  md:ms-2 dark:text-gray-400">
                    Gallery Page
                  </span>
                </div>
              </li>
      ...
      <div className="!sm:hidden  md:col-span-5 lg:xl:2xl:col-span-5  ">
        <div className="w-full  bg-gradient-to-r  from-white from-10% to-transparent  h-full"></div>
      </div>
    </section>
  );
};
